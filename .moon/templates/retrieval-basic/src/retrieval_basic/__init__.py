"""Retrieval Basic - PDF text extraction and context formatting for LLM applications.
...
Example usage:
    from retrieval_basic import extract_text_from_pdf, format_as_context, process_pdf_file
